...
import S_Timeline from "../secondPage/S_Timeline";

export default function S_RightContact() {
    return (
        // <div className="flex mt-[30px] ml-1 flex-col bg-emerald-400">
        <div className="flex mt-[30px] ml-1 flex-col">
            {/* <div>
